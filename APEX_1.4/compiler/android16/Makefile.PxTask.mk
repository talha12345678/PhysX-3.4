...
PxTask_debug_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxTask_debug_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
PxTask_debug_lpaths    := 
...
PxTask_debug_defines   += PX_NVTX=0
...
PxTask_debug_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxTask_debug_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxTask_debug_cpp_o): $(PxTask_debug_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_debug_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxTask_debug_objsdir),, $@))), $(PxTask_cppfiles))
...
$(PxTask_debug_cc_o): $(PxTask_debug_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_debug_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxTask_debug_objsdir),, $@))), $(PxTask_ccfiles))
...
$(PxTask_debug_c_o): $(PxTask_debug_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxTask_debug_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxTask_debug_objsdir),, $@))), $(PxTask_cfiles))
...
PxTask_release_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxTask_release_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxTask_release_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxTask_release_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxTask_release_cpp_o): $(PxTask_release_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_release_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxTask_release_objsdir),, $@))), $(PxTask_cppfiles))
...
$(PxTask_release_cc_o): $(PxTask_release_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_release_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxTask_release_objsdir),, $@))), $(PxTask_ccfiles))
...
$(PxTask_release_c_o): $(PxTask_release_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxTask_release_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxTask_release_objsdir),, $@))), $(PxTask_cfiles))
...
PxTask_checked_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxTask_checked_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxTask_checked_defines   += PX_NVTX=0
...
PxTask_checked_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxTask_checked_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxTask_checked_cpp_o): $(PxTask_checked_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_checked_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxTask_checked_objsdir),, $@))), $(PxTask_cppfiles))
...
$(PxTask_checked_cc_o): $(PxTask_checked_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_checked_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxTask_checked_objsdir),, $@))), $(PxTask_ccfiles))
...
$(PxTask_checked_c_o): $(PxTask_checked_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxTask_checked_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxTask_checked_objsdir),, $@))), $(PxTask_cfiles))
...
PxTask_profile_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxTask_profile_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxTask_profile_defines   += PX_NVTX=0
...
PxTask_profile_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxTask_profile_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxTask_profile_cpp_o): $(PxTask_profile_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_profile_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxTask_profile_objsdir),, $@))), $(PxTask_cppfiles))
...
$(PxTask_profile_cc_o): $(PxTask_profile_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxTask_profile_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxTask_profile_objsdir),, $@))), $(PxTask_ccfiles))
...
$(PxTask_profile_c_o): $(PxTask_profile_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxTask_profile_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxTask_profile_objsdir),, $@))), $(PxTask_cfiles))
