...
PxPvdSDK_debug_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxPvdSDK_debug_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxPvdSDK_debug_defines   += PX_NVTX=0
...
PxPvdSDK_debug_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxPvdSDK_debug_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxPvdSDK_debug_cpp_o): $(PxPvdSDK_debug_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_debug_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_debug_objsdir),, $@))), $(PxPvdSDK_cppfiles))
...
$(PxPvdSDK_debug_cc_o): $(PxPvdSDK_debug_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_debug_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_debug_objsdir),, $@))), $(PxPvdSDK_ccfiles))
...
$(PxPvdSDK_debug_c_o): $(PxPvdSDK_debug_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxPvdSDK_debug_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_debug_objsdir),, $@))), $(PxPvdSDK_cfiles))
...
PxPvdSDK_release_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxPvdSDK_release_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxPvdSDK_release_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxPvdSDK_release_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxPvdSDK_release_cpp_o): $(PxPvdSDK_release_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_release_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_release_objsdir),, $@))), $(PxPvdSDK_cppfiles))
...
$(PxPvdSDK_release_cc_o): $(PxPvdSDK_release_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_release_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_release_objsdir),, $@))), $(PxPvdSDK_ccfiles))
...
$(PxPvdSDK_release_c_o): $(PxPvdSDK_release_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxPvdSDK_release_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_release_objsdir),, $@))), $(PxPvdSDK_cfiles))
...
PxPvdSDK_checked_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxPvdSDK_checked_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxPvdSDK_checked_defines   += PX_NVTX=0
...
PxPvdSDK_checked_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxPvdSDK_checked_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxPvdSDK_checked_cpp_o): $(PxPvdSDK_checked_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_checked_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_checked_objsdir),, $@))), $(PxPvdSDK_cppfiles))
...
$(PxPvdSDK_checked_cc_o): $(PxPvdSDK_checked_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_checked_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_checked_objsdir),, $@))), $(PxPvdSDK_ccfiles))
...
$(PxPvdSDK_checked_c_o): $(PxPvdSDK_checked_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxPvdSDK_checked_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_checked_objsdir),, $@))), $(PxPvdSDK_cfiles))
...
PxPvdSDK_profile_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PxPvdSDK_profile_hpaths    += ./../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PxPvdSDK_profile_defines   += PX_NVTX=0
...
PxPvdSDK_profile_common_cflags  += -isysroot ./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PxPvdSDK_profile_lflags  += --sysroot=./../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
$(PxPvdSDK_profile_cpp_o): $(PxPvdSDK_profile_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_profile_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PxPvdSDK_profile_objsdir),, $@))), $(PxPvdSDK_cppfiles))
...
$(PxPvdSDK_profile_cc_o): $(PxPvdSDK_profile_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PxPvdSDK_profile_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PxPvdSDK_profile_objsdir),, $@))), $(PxPvdSDK_ccfiles))
...
$(PxPvdSDK_profile_c_o): $(PxPvdSDK_profile_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PxPvdSDK_profile_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PxPvdSDK_profile_objsdir),, $@))), $(PxPvdSDK_cfiles))
