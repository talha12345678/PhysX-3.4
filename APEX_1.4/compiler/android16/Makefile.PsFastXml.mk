...
PsFastXml_debug_bin      := ./../../../PxShared/lib/android16/libPsFastXmlDEBUG.a
...
$(PsFastXml_debug_bin): $(PsFastXml_debug_obj) 
	mkdir -p `dirname ./../../../PxShared/lib/android16/libPsFastXmlDEBUG.a`
...
$(PsFastXml_debug_cpp_o): $(PsFastXml_debug_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_debug_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_debug_objsdir),, $@))), $(PsFastXml_cppfiles))
...
$(PsFastXml_debug_cc_o): $(PsFastXml_debug_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_debug_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_debug_objsdir),, $@))), $(PsFastXml_ccfiles))
...
$(PsFastXml_debug_c_o): $(PsFastXml_debug_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PsFastXml_debug_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_debug_objsdir),, $@))), $(PsFastXml_cfiles))
...
PsFastXml_release_bin      := ./../../../PxShared/lib/android16/libPsFastXml.a
...
$(PsFastXml_release_bin): $(PsFastXml_release_obj) 
	mkdir -p `dirname ./../../../PxShared/lib/android16/libPsFastXml.a`
...
$(PsFastXml_release_cpp_o): $(PsFastXml_release_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_release_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_release_objsdir),, $@))), $(PsFastXml_cppfiles))
...
$(PsFastXml_release_cc_o): $(PsFastXml_release_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_release_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_release_objsdir),, $@))), $(PsFastXml_ccfiles))
...
$(PsFastXml_release_c_o): $(PsFastXml_release_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PsFastXml_release_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_release_objsdir),, $@))), $(PsFastXml_cfiles))
...
PsFastXml_checked_bin      := ./../../../PxShared/lib/android16/libPsFastXmlCHECKED.a
...
$(PsFastXml_checked_bin): $(PsFastXml_checked_obj) 
	mkdir -p `dirname ./../../../PxShared/lib/android16/libPsFastXmlCHECKED.a`
...
$(PsFastXml_checked_cpp_o): $(PsFastXml_checked_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_checked_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_checked_objsdir),, $@))), $(PsFastXml_cppfiles))
...
$(PsFastXml_checked_cc_o): $(PsFastXml_checked_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_checked_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_checked_objsdir),, $@))), $(PsFastXml_ccfiles))
...
$(PsFastXml_checked_c_o): $(PsFastXml_checked_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PsFastXml_checked_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_checked_objsdir),, $@))), $(PsFastXml_cfiles))
...
PsFastXml_profile_bin      := ./../../../PxShared/lib/android16/libPsFastXmlPROFILE.a
...
$(PsFastXml_profile_bin): $(PsFastXml_profile_obj) 
	mkdir -p `dirname ./../../../PxShared/lib/android16/libPsFastXmlPROFILE.a`
...
$(PsFastXml_profile_cpp_o): $(PsFastXml_profile_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_profile_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PsFastXml_profile_objsdir),, $@))), $(PsFastXml_cppfiles))
...
$(PsFastXml_profile_cc_o): $(PsFastXml_profile_objsdir)/%.o:
	...
	$(CXX_NOCACHE) -MM -MT '$@' $(PsFastXml_profile_cppflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .cc.o,.cc, $(subst $(PsFastXml_profile_objsdir),, $@))), $(PsFastXml_ccfiles))
...
$(PsFastXml_profile_c_o): $(PsFastXml_profile_objsdir)/%.o:
	...
	$(CC_NOCACHE) -MM -MT '$@' $(PsFastXml_profile_cflags) -o $(dir $(@))/$(*F).d $(filter %$(strip $(subst .c.o,.c, $(subst $(PsFastXml_profile_objsdir),, $@))), $(PsFastXml_cfiles))
