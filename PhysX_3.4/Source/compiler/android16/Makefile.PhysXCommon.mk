...
PhysXCommon_cfiles   += ./../../../../Externals/android-ndk-r14b/sources/android/cpufeatures/cpu-features.c
...
PhysXCommon_release_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PhysXCommon_release_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PhysXCommon_release_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/android/cpufeatures
...
PhysXCommon_release_lpaths    += ./../../../../PxShared/lib/android16
...
PhysXCommon_release_defines   += __STDC_LIMIT_MACROS
...
PhysXCommon_release_libraries += PxFoundation
...
#PhysXCommon_release_common_cflags  += -Werror
PhysXCommon_release_common_cflags  += -fpic -fno-exceptions
PhysXCommon_release_common_cflags  += -isysroot ../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
PhysXCommon_release_common_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
PhysXCommon_release_common_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysXCommon_release_common_cflags  += -Wno-maybe-uninitialized -Wno-unused-variable
PhysXCommon_release_common_cflags  += -Wno-variadic-macros
PhysXCommon_release_common_cflags  += -O3 -fno-strict-aliasing
PhysXCommon_release_common_cflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysXCommon_release_common_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
PhysXCommon_release_lflags  += --sysroot=../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PhysXCommon_release_bin      := ./../../../Lib/android16/libPhysX3Common.a
...
$(PhysXCommon_release_bin): $(PhysXCommon_release_obj) build_PxFoundation_release 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3Common.a`
...
PhysXCommon_debug_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PhysXCommon_debug_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PhysXCommon_debug_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/android/cpufeatures
...
PhysXCommon_debug_defines   += PX_NVTX=0
PhysXCommon_debug_libraries := 
PhysXCommon_debug_libraries += PxFoundationDEBUG
...
#PhysXCommon_debug_common_cflags  += -Werror
PhysXCommon_debug_common_cflags  += -fpic -fno-exceptions
PhysXCommon_debug_common_cflags  += -isysroot ../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
PhysXCommon_debug_common_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
PhysXCommon_debug_common_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysXCommon_debug_common_cflags  += -Wno-maybe-uninitialized -Wno-unused-variable
PhysXCommon_debug_common_cflags  += -Wno-variadic-macros
...
PhysXCommon_debug_lflags  += --sysroot=../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PhysXCommon_debug_bin      := ./../../../Lib/android16/libPhysX3CommonDEBUG.a
...
$(PhysXCommon_debug_bin): $(PhysXCommon_debug_obj) build_PxFoundation_debug 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3CommonDEBUG.a`
...
PhysXCommon_checked_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PhysXCommon_checked_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PhysXCommon_checked_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/android/cpufeatures
...
PhysXCommon_checked_lpaths    += ./../../../../PxShared/lib/android16
...
PhysXCommon_checked_defines   += __STDC_LIMIT_MACROS
...
PhysXCommon_checked_defines   += PX_NVTX=0
PhysXCommon_checked_libraries := 
PhysXCommon_checked_libraries += PxFoundationCHECKED
...
#PhysXCommon_checked_common_cflags  += -Werror
PhysXCommon_checked_common_cflags  += -fpic -fno-exceptions
PhysXCommon_checked_common_cflags  += -isysroot ../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
PhysXCommon_checked_common_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
PhysXCommon_checked_common_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysXCommon_checked_common_cflags  += -Wno-maybe-uninitialized -Wno-unused-variable
PhysXCommon_checked_common_cflags  += -Wno-variadic-macros
PhysXCommon_checked_common_cflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
PhysXCommon_checked_common_cflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysXCommon_checked_common_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
PhysXCommon_checked_lflags  += --sysroot=../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PhysXCommon_checked_bin      := ./../../../Lib/android16/libPhysX3CommonCHECKED.a
...
$(PhysXCommon_checked_bin): $(PhysXCommon_checked_obj) build_PxFoundation_checked 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3CommonCHECKED.a`
...
PhysXCommon_profile_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/include
PhysXCommon_profile_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/include
...
PhysXCommon_profile_hpaths    += ./../../../../Externals/android-ndk-r14b/sources/android/cpufeatures
...
PhysXCommon_profile_lpaths    += ./../../../../PxShared/lib/android16
...
PhysXCommon_profile_defines   += __STDC_LIMIT_MACROS
...
PhysXCommon_profile_defines   += PX_NVTX=0
PhysXCommon_profile_libraries := 
PhysXCommon_profile_libraries += PxFoundationPROFILE
...
#PhysXCommon_profile_common_cflags  += -Werror
PhysXCommon_profile_common_cflags  += -fpic -fno-exceptions
PhysXCommon_profile_common_cflags  += -isysroot ../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
PhysXCommon_profile_common_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
PhysXCommon_profile_common_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysXCommon_profile_common_cflags  += -Wno-maybe-uninitialized -Wno-unused-variable
PhysXCommon_profile_common_cflags  += -Wno-variadic-macros
PhysXCommon_profile_common_cflags  += -O3 -fno-strict-aliasing
PhysXCommon_profile_common_cflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysXCommon_profile_common_cflags  += -fno-omit-frame-pointer -funswitch-loops -finline-limit=300
...
PhysXCommon_profile_lflags  += --sysroot=../../../../Externals/android-ndk-r14b/platforms/android-21/arch-arm
...
PhysXCommon_profile_bin      := ./../../../Lib/android16/libPhysX3CommonPROFILE.a
...
$(PhysXCommon_profile_bin): $(PhysXCommon_profile_obj) build_PxFoundation_profile 
	mkdir -p `dirname ./../../../Lib/android16/libPhysX3CommonPROFILE.a`
